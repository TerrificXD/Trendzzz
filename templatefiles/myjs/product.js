...
function viewproduct() {
    ...
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var x in ar) {
                obj = ar[x];
                tab += "<tr style=\"font-size: 14px\">";
                tab += "<td>" + srno + "</td>";
                tab += "<td>" + obj.productname + "</td>";
                tab += "<td>" + obj.price + "</td>";
                tab += "<td>" + obj.stock + "</td>";
                tab += "<td>" + obj.discount + "</td>";
                tab += "<td><img style='height: 100px;width: 100px' src='" + obj.photo + "' alt=''><span style=\"cursor: pointer;color: #327dff;font-weight: bold;\" title='" + obj.description + "'>View&nbsp;Description</span>\n</td>";
                tab += "<td>" + obj.subcategoryname + "</td>";
                tab += "<td>" + obj.category + "</td>";
                tab += "<td><i onclick='deleteproduct(\"" + obj.productid + "\")'" + " class='fa fa-trash-alt text-danger' style='cursor: pointer;'></i></td>";
                ...
                tab += "<td><i onclick='viewproductphoto(\"" + obj.productid + "\")'" + " class='fa fa-photo-video text-danger' style='cursor: pointer;'></i></td>";
                tab += "</tr>";
                srno++;
            }
            // tab +="</tbody>";
    ...
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var x in ar) {
                ...
                tab += "<td><i onclick='deleteproductphoto(\"" + obj.id + "\")'" + " class='fa fa-trash-alt text-danger' style='cursor: pointer;'></i></td>";
                tab += "</tr>";
                srno++;
            }
            // tab +="</tbody>";
